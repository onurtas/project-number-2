...
if len(df_qualified) == 0:
    ...
    # X-axis
    ax.set_xlabel(ar("متوسط النبرة"), fontsize=11, color="#4B5563", fontweight="bold")
    ...
    # Title
    ax.set_title(ar("تصنيف معنويات العملات الرقمية (الإعلام الأمريكي)"),
    ...
    png_path = OUTDIR / f"ranking_b2_sentiment_ar_{tag}.png"
    ...
    json_path = OUTDIR / f"ranking_b2_sentiment_ar_{tag}.json"
    ...
    post_path = OUTDIR / f"ranking_b2_sentiment_ar_{tag}_post.json"
