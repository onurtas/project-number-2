...
# X-axis
ax.set_xlabel(ar("عدد الأخبار"), fontsize=11, color="#4B5563", fontweight="bold")
...
# Title
ax.set_title(ar("العملات الرقمية الأكثر تداولاً في الأخبار"),
...
png_path = OUTDIR / f"ranking_b1_volume_ar_{tag}.png"
...
json_path = OUTDIR / f"ranking_b1_volume_ar_{tag}.json"
...
post_path = OUTDIR / f"ranking_b1_volume_ar_{tag}_post.json"
